//
//  ImageCommnetsSnapshotsTests.swift
//  EssentialFeediOSTests
//
//  Created by Prabhat Tiwari on 24/09/25.
//
...
final class ImageCommnetsSnapshotsTests: XCTestCase {
    ...
    func test_listWithContent() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone8(style: .dark,contentSize: .extraExtraLarge)), named: "IMAGE_COMMENTS_dark_extraExtraLarge")
    }
